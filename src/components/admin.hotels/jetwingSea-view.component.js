                    ...
                    <section class="">
                        <div class="text-center bg-white text-gray-800 pt-10 px-6 pb-10">
                            <h1 class="text-5xl md:text-4xl xl:text-5xl font-bold tracking-tight uppercase mb-8 drop-shadow-md ">
                                <span class="text-blue-950 font-serif font-light  ">JETWING SEA HOTEL</span>
                            </h1>
                        </div>
                    </section>

                    <div class="w-100 pb-16">
                        <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2018/03/photo-gallery-desktop-large-1.jpg" alt="JetwingBlue" />
                    </div>
                    {/* events and meetings */}
                    <section class="">
