...
class CusJetwingSeaView extends Component {
            ...
            if (
                ...
                return (
                    ...
                    <tr className='bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                        ...
                        <td className='px-6 font-bold text-lg'>{currentevent.hallName}</td>
    ...
    searchWeddingHallList() {
        return this.state.wedding.map((currentWedding) => {
            if (
                ...
                return (
                    <div className="shadow-xl card w-96 bg-base-100 mb-12 mt-5 hover:scale-105" >
                        <figure><img src={currentWedding.imageURL} alt="Weddings" className='h-96' /></figure>
                        <div className="card-body">
                            <h2 className="justify-center card-title font-bold">{currentWedding.hallName}</h2>
                            <p className='text-justify px-3'>{currentWedding.description}</p>
            ...
            if (
                ...
                return (
                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                        ...
                        <td className='w-32 px-4 justify-center'>{currentRoom.roomName}</td>
    ...
    render() {
        return (
            <div class="">
                ...
                <div class="w-100">
                    <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2018/03/photo-gallery-desktop-large-1.jpg" alt="Jetwing Sea" />
                ...
                <section class="">
                    ...
                    <div class="grid grid-cols-2 divide-x">
                        <div class="text-center bg-white text-gray-800 pt-20 px-8 pb-10">
                            ...
                            <h3 class="text-3xl md:text-4xl xl:text-5xl font-bold tracking-tight uppercase mb-8 drop-shadow-md "><span class="text-blue-950 font-serif font-light  ">JETWING SEA HOTEL</span>
                            ...
                            <p>Ravindra de Silva
                                Manager – Jetwing Sea & Jetwing Beach</p>
                        </div>
                        <div class="max-w-[90%] mx-auto px-5 py-5 lg:px-32 lg:pt-16">
                            <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2019/07/sea-romance-category-744x653.jpg" alt="Events" class="h-[25rem] w-[80rem] pr-8 hover:animate-pulse" />
                        </div>
                ...
                <section class="">
                    ...
                    <div class="max-w-[90%] mx-auto px-5 py-5 lg:px-32 lg:pt-12">
                        <table>
                            <tr>
                                <td rowspan="2"><div >
                                    <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2019/06/suite-gallery-2-744x502.jpg" alt="Events" class="h-[30rem] w-[100rem] transition duration-300 ease-in-out hover:opacity-40" />
                                </div></td>
                                <td><div >
                                    <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2018/03/sea-main-desktop.jpg" alt="Events" class="h-[15rem] w-[80rem] transition duration-300 ease-in-out hover:opacity-40" />
                                </div></td>
                            </tr>
                            <tr>
                                <td>
                                    <div >
                                        <img src="https://www.jetwinghotels.com/jetwingsea/wp-content/uploads/sites/27/2019/06/suite-gallery-1-744x502.jpg" alt="Events" class="h-[15rem] w-[80rem] transition duration-300 ease-in-out hover:opacity-40" />
                                    </div>
                                </td>
                            </tr>
                        </table>
...
export default CusJetwingSeaView;